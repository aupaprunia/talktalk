...
public abstract class RtcBaseActivity extends BaseActivity implements EventHandler {
    ...
    private void joinChannel() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(com.hackillionis.talktalk.util.Constants.MY_PREF,MODE_PRIVATE);
        rtcEngine().joinChannel(token,sharedPreferences.getString(com.hackillionis.talktalk.util.Constants.CONNECT_TO,"guest") , "", 0);
    }
